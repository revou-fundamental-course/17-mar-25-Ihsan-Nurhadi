...
function calculateArea() {
    ...
    document.getElementById('result').innerText = `Luas Persegi: ${area} satuan²`;
}
function calculateCircumference() {
    const side = document.getElementById('sideCircumference').value;
    const circumference = side * 4; // Menghitung keliling
    document.getElementById('resultCircumference').innerText = `Keliling Persegi: ${circumference} satuan`;
}
...
function menghitungluas() {
    ...
    document.getElementById('hasilluas').innerText = `Luas Persegi Panjang: ${luas} satuan²`;
}
function menghitungkeliling() {
    const panjang = document.getElementById('panjang2').value;
    const lebar = document.getElementById('lebar2').value;
    const keliling = 2 * panjang + 2 * lebar;
    document.getElementById('hasilkeliling').innerText = `Keliling Persegi Panjang: ${keliling} satuan`;
}